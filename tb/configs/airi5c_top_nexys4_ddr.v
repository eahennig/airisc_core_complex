...
//
//
// File              : airi5c_top_nexys4_ddr.v
// Author            : A. Stanitzki / E. Hennig
// Creation Date     : 09.10.20 / 02.08.2025
// Version           : 1.0
// Abstract          : AIRI5C top level for the Digilent Nexys4 DDR FPGA implementation
//
...
// 7-segment display
   output [7:0]                    disp7seg_data,
   output [7:0]                    disp7seg_scan,
...
// -- Post-Synthesis debug port --
  ...
  wire [`HASTI_BUS_WIDTH-1:0]     per_hrdata_disp7seg;
  wire [`HASTI_RESP_WIDTH-1:0]    per_hresp_disp7seg;
  wire                            per_hready_disp7seg;  
...
`endif
  ...
  (
    .S_COUNT(8),
    .S_BASE_ADDR({`MEMORY_BASE_ADDR,`SYSTEM_TIMER_BASE_ADDR,`UART0_BASE_ADDR,`SPI0_BASE_ADDR,`GPIO0_BASE_ADDR,`ICAP_BASE_ADDR,`TRNG_BASE_ADDR,`DISP7SEG_BASE_ADDR}),
    .S_ADDR_WIDTH({`MEMORY_ADDR_WIDTH,`SYSTEM_TIMER_ADDR_WIDTH,`UART0_ADDR_WIDTH,`SPI0_ADDR_WIDTH,`GPIO0_ADDR_WIDTH,`ICAP_ADDR_WIDTH,`TRNG_ADDR_WIDTH,`DISP7SEG_ADDR_WIDTH})
  )
  peripheral_mux ( 
    .clk_i(clk),
    .rst_ni(nrst),
    ...
    .s_hready({dmem_hready,per_hready_system_timer,per_hready_uart0,per_hready_spi0,per_hready_gpio0,per_hready_icap,per_hready_trng,per_hready_disp7seg}),
    .s_hresp({dmem_hresp,per_hresp_system_timer,per_hresp_uart0,per_hresp_spi0,per_hresp_gpio0,per_hresp_icap,per_hresp_trng,per_hresp_disp7seg}),
    .s_hrdata({dmem_hrdata,per_hrdata_system_timer,per_hrdata_uart0,per_hrdata_spi0,per_hrdata_gpio0,per_hrdata_icap,per_hrdata_trng,per_hrdata_disp7seg})
  );
  ...
  airi5c_nexys4_ddr_7seg_display
  #(
    .BASE_ADDR(`DISP7SEG_BASE_ADDR),
    .SCAN_FREQ(60)
  )
  disp7seg (
    .nreset(nrst),
    ...
    .htrans(dmem_htrans),
    .hwdata(dmem_hwdata),
    .hrdata(per_hrdata_disp7seg),
    .hready(per_hready_disp7seg),
    .hresp(per_hresp_disp7seg)
  );
