...
`endif
  ...
  // SPI 0
    ...
    (
      ...
      // 7-segment display
        .disp7seg_data(disp7seg_data),
        .disp7seg_scan(disp7seg_scan),
...
`ifdef DUAL_PORT
    ...
    blk_mem_gen_0 SRAM
    (
        .addra(imem_haddr[19:2]),
        .clka(clktree_root),
        .dina(imem_hwdata),
        .douta(imem_hrdata),
        .wea(4'h0),

        .addrb(|dmem_we ? dmem_haddr_r[19:2] : dmem_haddr[19:2]),
        .clkb(clktree_root),
        .dinb(dmem_hwdata),
        .doutb(dmem_hrdata),
        .web(dmem_we)
